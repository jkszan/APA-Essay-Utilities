...
public class InputHandler {
    ...
    // Parse function checks input command string for a registered command, if a
    // command is identified
    // it is called in commandHandler, else it is flagged as an error and displayed
    // as such in outputConsole

...
public class CommandHandler {
    ...
    // Arrays text and quotes store the text of the paper and quotes of the paper
    // for use in other functions
    String[] text, quotes;

    // outputConsole serves as a reference back to the active instance of
    // TerminalConsole to allow it to display information
    ...
    public void paperAnalytics(String input) {
        ...
        // Initializing queues for both the text and quotes to make the processing
        // simpler
        Queue<String> textQueue, quoteQueue;
        textQueue = new LinkedList<String>();
        quoteQueue = new LinkedList<String>();

        // This loop checks for the beginning of a quote. If it detects a quote it sends
        // the index
        // to the quotesSubroutine helper function, else it adds the word to the
        // textQueue
    ...
    private int quotesSubroutine(String[] inputList, int i, Queue<String> quoteQueue) {
        ...
        // This loop stores the entirety of a quote as one string as to not clutter
        // output when calling quotes
        String quote = "";
    ...
    public void text() {
        ...
        // This loop reformats the int[] text into a more easily readable string version
